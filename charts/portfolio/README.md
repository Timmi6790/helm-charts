...
![Version: 1.0.8](https://img.shields.io/badge/Version-1.0.8-informational?style=flat-square) ![AppVersion: v1.4.0](https://img.shields.io/badge/AppVersion-v1.4.0-informational?style=flat-square)
...
| image.tag | string | `"v1.4.0@sha256:c5b9ba6b1dae8cff533eaa22ebb8ebfd45a1ebec394427cbed67b552b195ff9a"` | Container image tag to deploy. |
